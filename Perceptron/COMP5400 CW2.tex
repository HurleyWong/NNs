...
\subfigure[with learning rate 0.01]{
	...
	\includegraphics[width=1\textwidth]{console1.png}
	\end{minipage}
}
\subfigure[without learning rate]{
	\begin{minipage}[b]{0.46\textwidth}
	\includegraphics[width=1\textwidth]{console2.png}
	\end{minipage}
}
...
\subfigure[with learning rate 0.01]{
	\begin{minipage}[b]{0.46\textwidth}
	\includegraphics[width=1\textwidth]{console4.png}
	\end{minipage}
}
\subfigure[without learning rate]{
	\begin{minipage}[b]{0.46\textwidth}
	\includegraphics[width=1\textwidth]{console3.png}
	\end{minipage}
}
...
\subfigure[with learning rate 0.01]{
	\begin{minipage}[b]{0.46\textwidth}
	\includegraphics[width=1\textwidth]{console6.png}
	\end{minipage}
}
\subfigure[without learning rate]{
	\begin{minipage}[b]{0.46\textwidth}
	\includegraphics[width=1\textwidth]{console5.png}
	\end{minipage}
}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.3]{ViO.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.3]{full_neural.png}
...
\centering
\subfigure[accuracy1.]{
\includegraphics[width=5.5cm]{accuracy1.png}
}
\quad
\subfigure[accuracy2.]{
\includegraphics[width=5.5cm]{accuracy2.png}
}
\quad
\subfigure[accuracy3.]{
\includegraphics[width=5.5cm]{accuracy3.png}
}
\quad
\subfigure[accuracy4.]{
\includegraphics[width=5.5cm]{accuracy4.png}
}
\caption{Accuracies}
\end{figure}
\noindent
